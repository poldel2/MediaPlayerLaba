...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        etUsername = findViewById(R.id.loginEdit)
        ...
        registerButton.setOnClickListener {
            ...
            registerViewModel.registerDataChanged(login, name, password, confirmPassword, birthDay)
        ...
        registerViewModel.registerFormState.observe(this@RegisterActivity, Observer {
            ...
            if (registerState.loginError != null) {
                etFirstName.error = getString(registerState.loginError)
            }
            if (registerState.nameError != null) {
                etLastName.error = getString(registerState.nameError)
            }
            if (registerState.birthDayError != null) {
                etBirthday.error = getString(registerState.birthDayError)
            }
            if (registerState.passwordError != null) {
                etPassword.error = getString(registerState.passwordError)
            }
            if (registerState.confirmPasswordError != null) {
                etConfirmPassword.error = getString(registerState.confirmPasswordError)
            }
